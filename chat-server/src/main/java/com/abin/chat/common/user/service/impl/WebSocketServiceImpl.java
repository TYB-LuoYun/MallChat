...
import com.abin.chat.common.common.config.ThreadPoolConfig;
import com.abin.chat.common.common.constant.RedisKey;
import com.abin.chat.common.common.event.UserOfflineEvent;
import com.abin.chat.common.common.event.UserOnlineEvent;
...
import com.abin.chat.common.websocket.NettyUtil;
import com.abin.chat.common.user.domain.dto.WSChannelExtraDTO;
...
import com.abin.chat.common.user.service.LoginService;
...
//        WxMpQrCodeTicket wxMpQrCodeTicket = wxMpService.getQrcodeService().qrCodeCreateTmpTicket(code, (int) EXPIRE_TIME.getSeconds());
        ...
        WSBaseResp<Map> wsBaseResp = new WSBaseResp<>();
        wsBaseResp.setType(WSRespTypeEnum.CHANNEL_CODE.getType());
        Map<Object, Object> map = new HashMap<>();
        map.put("channelCode", code);
        wsBaseResp.setData(map);
