package com.abin.chat.common.user.dao;

import com.abin.chat.common.user.domain.entity.UserApply;
import com.abin.chat.common.user.domain.enums.ApplyStatusEnum;
import com.abin.chat.common.user.domain.enums.ApplyTypeEnum;
import com.abin.chat.common.user.mapper.UserApplyMapper;
...
import static com.abin.chat.common.user.domain.enums.ApplyReadStatusEnum.READ;
import static com.abin.chat.common.user.domain.enums.ApplyReadStatusEnum.UNREAD;
import static com.abin.chat.common.user.domain.enums.ApplyStatusEnum.AGREE;
