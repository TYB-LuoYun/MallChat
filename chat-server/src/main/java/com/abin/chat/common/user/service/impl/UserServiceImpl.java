...
import com.abin.chat.common.common.algorithm.sensitiveWord.SensitiveWordBs;
import com.abin.chat.common.common.event.UserBlackEvent;
import com.abin.chat.common.common.event.UserRegisterEvent;
import com.abin.chat.common.common.utils.AssertUtil;
import com.abin.chat.common.user.dao.BlackDao;
import com.abin.chat.common.user.dao.ItemConfigDao;
import com.abin.chat.common.user.dao.UserBackpackDao;
import com.abin.chat.common.user.dao.UserDao;
import com.abin.chat.common.user.domain.vo.request.user.*;
import com.abin.chat.common.user.service.adapter.UserAdapter;
import com.abin.chat.common.user.service.cache.ItemCache;
import com.abin.chat.common.user.service.cache.UserCache;
import com.abin.chat.common.user.service.cache.UserSummaryCache;
import com.abin.chat.common.user.domain.dto.ItemInfoDTO;
import com.abin.chat.common.user.domain.dto.SummeryInfoDTO;
import com.abin.chat.common.user.domain.entity.Black;
import com.abin.chat.common.user.domain.entity.ItemConfig;
import com.abin.chat.common.user.domain.entity.User;
import com.abin.chat.common.user.domain.entity.UserBackpack;
import com.abin.chat.common.user.domain.enums.BlackTypeEnum;
import com.abin.chat.common.user.domain.enums.ItemEnum;
import com.abin.chat.common.user.domain.enums.ItemTypeEnum;
import com.abin.mallchat.common.user.domain.vo.request.user.*;
import com.abin.chat.common.user.domain.vo.response.user.BadgeResp;
import com.abin.chat.common.user.domain.vo.response.user.UserInfoResp;
import com.abin.chat.common.user.service.UserService;
