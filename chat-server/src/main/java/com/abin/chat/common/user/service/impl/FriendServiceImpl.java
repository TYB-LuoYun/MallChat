package com.abin.chat.common.user.service.impl;

import cn.hutool.core.collection.CollectionUtil;
import com.abin.chat.common.chat.dao.RoomFriendDao;
import com.abin.chat.common.chat.domain.entity.RoomFriend;
...
import com.abin.chat.common.common.domain.vo.request.PageBaseReq;
import com.abin.chat.common.common.domain.vo.response.CursorPageBaseResp;
import com.abin.chat.common.common.domain.vo.response.PageBaseResp;
import com.abin.chat.common.common.event.UserApplyEvent;
import com.abin.chat.common.common.utils.AssertUtil;
import com.abin.chat.common.user.dao.UserApplyDao;
import com.abin.chat.common.user.dao.UserDao;
import com.abin.chat.common.user.dao.UserFriendDao;
import com.abin.chat.common.user.service.adapter.FriendAdapter;
import com.abin.chat.common.user.domain.entity.User;
import com.abin.chat.common.user.domain.entity.UserApply;
import com.abin.chat.common.user.domain.entity.UserFriend;
import com.abin.chat.common.user.domain.vo.request.friend.FriendApplyReq;
import com.abin.chat.common.user.domain.vo.request.friend.FriendApproveReq;
import com.abin.chat.common.user.domain.vo.request.friend.FriendCheckReq;
import com.abin.chat.common.user.domain.vo.response.friend.FriendApplyResp;
import com.abin.chat.common.user.domain.vo.response.friend.FriendCheckResp;
import com.abin.chat.common.user.domain.vo.response.friend.FriendResp;
import com.abin.chat.common.user.domain.vo.response.friend.FriendUnreadResp;
import com.abin.chat.common.user.service.FriendService;
...
import static com.abin.chat.common.user.domain.enums.ApplyStatusEnum.WAIT_APPROVAL;
