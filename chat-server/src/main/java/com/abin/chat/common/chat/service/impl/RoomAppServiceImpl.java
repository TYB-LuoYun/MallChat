package com.abin.chat.common.chat.service.impl;

import cn.hutool.core.collection.CollectionUtil;
import cn.hutool.core.lang.Pair;
import com.abin.chat.common.chat.domain.entity.*;
import com.abin.chat.common.chat.service.adapter.ChatAdapter;
import com.abin.chat.common.chat.service.adapter.MemberAdapter;
import com.abin.chat.common.chat.service.adapter.RoomAdapter;
import com.abin.chat.common.chat.service.cache.*;
import com.abin.chat.common.chat.service.strategy.msg.AbstractMsgHandler;
import com.abin.chat.common.chat.service.strategy.msg.MsgHandlerFactory;
import com.abin.chat.common.user.dao.UserDao;
import com.abin.chat.common.chat.dao.ContactDao;
import com.abin.chat.common.chat.dao.GroupMemberDao;
import com.abin.chat.common.chat.dao.MessageDao;
import com.abin.chat.common.chat.domain.dto.RoomBaseInfo;
import com.abin.mallchat.common.chat.domain.entity.*;
import com.abin.chat.common.chat.domain.enums.GroupRoleAPPEnum;
import com.abin.chat.common.chat.domain.enums.GroupRoleEnum;
import com.abin.chat.common.chat.domain.enums.HotFlagEnum;
import com.abin.chat.common.chat.domain.enums.RoomTypeEnum;
import com.abin.chat.common.chat.domain.vo.request.ChatMessageMemberReq;
import com.abin.chat.common.chat.domain.vo.request.GroupAddReq;
import com.abin.chat.common.chat.domain.vo.request.member.MemberAddReq;
import com.abin.chat.common.chat.domain.vo.request.member.MemberDelReq;
import com.abin.chat.common.chat.domain.vo.request.member.MemberReq;
import com.abin.chat.common.chat.domain.vo.response.ChatMemberListResp;
import com.abin.chat.common.chat.domain.vo.response.ChatRoomResp;
import com.abin.chat.common.chat.domain.vo.response.MemberResp;
import com.abin.chat.common.chat.service.ChatService;
import com.abin.chat.common.chat.service.RoomAppService;
import com.abin.chat.common.chat.service.RoomService;
import com.abin.mallchat.common.chat.service.cache.*;
import com.abin.chat.common.common.annotation.RedissonLock;
import com.abin.chat.common.common.domain.vo.request.CursorPageBaseReq;
import com.abin.chat.common.common.domain.vo.response.CursorPageBaseResp;
import com.abin.chat.common.common.event.GroupMemberAddEvent;
import com.abin.chat.common.common.exception.GroupErrorEnum;
import com.abin.chat.common.common.utils.AssertUtil;
import com.abin.chat.common.user.domain.entity.User;
import com.abin.chat.common.user.domain.enums.RoleEnum;
import com.abin.chat.common.user.domain.enums.WSBaseResp;
import com.abin.chat.common.user.domain.vo.response.ws.ChatMemberResp;
import com.abin.chat.common.user.domain.vo.response.ws.WSMemberChange;
import com.abin.chat.common.user.service.IRoleService;
import com.abin.chat.common.user.service.cache.UserCache;
import com.abin.chat.common.user.service.cache.UserInfoCache;
