package com.abin.chat.common.chat.service.adapter;
...
import static com.abin.chat.common.user.domain.vo.response.ws.WSMemberChange.CHANGE_TYPE_ADD;
import static com.abin.chat.common.user.domain.vo.response.ws.WSMemberChange.CHANGE_TYPE_REMOVE;
