...
import com.abin.chat.user.domain.enums.ApplyStatusEnum;
import com.abin.chat.user.domain.enums.ApplyTypeEnum;
import com.abin.chat.user.mapper.UserApplyMapper;
...
import static com.abin.chat.user.domain.enums.ApplyReadStatusEnum.READ;
import static com.abin.chat.user.domain.enums.ApplyReadStatusEnum.UNREAD;
import static com.abin.chat.user.domain.enums.ApplyStatusEnum.AGREE;
