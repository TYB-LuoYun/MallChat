...
import com.abin.chat.chat.dao.RoomFriendDao;
import com.abin.chat.chat.domain.entity.RoomFriend;
import com.abin.chat.chat.service.ChatService;
import com.abin.chat.chat.service.ContactService;
import com.abin.chat.chat.service.RoomService;
...
import com.abin.chat.common.domain.vo.request.PageBaseReq;
import com.abin.chat.common.domain.vo.response.CursorPageBaseResp;
import com.abin.chat.common.domain.vo.response.PageBaseResp;
...
import com.abin.chat.user.dao.UserFriendDao;
import com.abin.chat.user.service.adapter.FriendAdapter;
import com.abin.chat.user.domain.entity.User;
import com.abin.chat.user.domain.entity.UserApply;
import com.abin.chat.user.domain.entity.UserFriend;
import com.abin.chat.user.domain.vo.request.friend.FriendApplyReq;
import com.abin.chat.user.domain.vo.request.friend.FriendApproveReq;
import com.abin.chat.user.domain.vo.request.friend.FriendCheckReq;
import com.abin.chat.user.domain.vo.response.friend.FriendApplyResp;
import com.abin.chat.user.domain.vo.response.friend.FriendCheckResp;
import com.abin.chat.user.domain.vo.response.friend.FriendResp;
import com.abin.chat.user.domain.vo.response.friend.FriendUnreadResp;
import com.abin.chat.user.service.FriendService;
...
import static com.abin.chat.user.domain.enums.ApplyStatusEnum.WAIT_APPROVAL;
