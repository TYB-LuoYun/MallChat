package com.abin.chat.user.service.adapter;
...
import static com.abin.chat.user.domain.enums.ApplyReadStatusEnum.UNREAD;
import static com.abin.chat.user.domain.enums.ApplyStatusEnum.WAIT_APPROVAL;
import static com.abin.chat.user.domain.enums.ApplyTypeEnum.ADD_FRIEND;
