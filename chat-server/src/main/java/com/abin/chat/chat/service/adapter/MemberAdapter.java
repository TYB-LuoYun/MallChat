...
import static com.abin.chat.user.domain.vo.response.ws.WSMemberChange.CHANGE_TYPE_ADD;
import static com.abin.chat.user.domain.vo.response.ws.WSMemberChange.CHANGE_TYPE_REMOVE;
